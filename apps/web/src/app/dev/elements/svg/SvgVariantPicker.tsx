...
export function SvgVariantPicker({ controller }: { controller: SvgElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code>elementSVGSchema</code> + <code>elementLayoutSchema</code>. Variant
