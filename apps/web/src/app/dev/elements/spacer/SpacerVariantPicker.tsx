...
export function SpacerVariantPicker({ controller }: { controller: SpacerElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code>elementSpacerSchema</code> + <code>elementLayoutSchema</code>. Variants
        represent small, medium, and large spacing steps.
      </p>
