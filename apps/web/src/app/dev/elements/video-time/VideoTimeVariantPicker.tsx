...
export function VideoTimeVariantPicker({
  controller,
}: {
  ...
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code>elementVideoTimeSchema</code> + <code>elementLayoutSchema</code>.
        Content is controlled by the video player context at runtime.
      </p>
