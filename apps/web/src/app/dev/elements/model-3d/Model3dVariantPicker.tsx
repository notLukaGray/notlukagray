...
export function Model3dVariantPicker({ controller }: { controller: Model3dElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code className="font-mono text-[10px]">elementModel3DSchema</code> +{" "}
        <code className="font-mono text-[10px]">elementLayoutSchema</code>. Scene/model config is
        authored in the Custom JSON panel.
      </p>
