...
export function VideoVariantPicker({ controller }: { controller: VideoElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code>elementVideoSchema</code> + <code>elementLayoutSchema</code>. Variants
        cover inline, compact, full-cover, and hero video use cases with starter module overlays.
      </p>
