...
export function BodyLayoutControls({ controller }: { controller: BodyElementDevController }) {
  ...
  return (
    <>
      ...
      <SharedFoundationLayoutFields<BodyVariantDefaults>
        variant={active}
        onPatch={(patch) => setVariantPatch(activeVariant, patch)}
      />
      <SharedTypographySizingFields<BodyVariantDefaults>
        variant={active}
        onPatch={(patch) => setVariantPatch(activeVariant, patch)}
      />
    </>
