...
export function ImageRuntimeControls({ controller }: { controller: ImageElementDevController }) {
      ...
      intro={
        <div className="sm:col-span-2 rounded border border-border/60 bg-muted/20 px-3 py-2">
          ...
          <p className="mt-1 text-[10px] text-muted-foreground">
            Instance-level fields for custom snippets. These do not alter defaults schema, but they
            do drive preview + copy JSON.
          </p>
        </div>
      }
    />
