...
export function HeadingLayoutControls({ controller }: { controller: HeadingElementDevController }) {
  ...
  return (
    <>
      ...
      <SharedFoundationLayoutFields<HeadingVariantDefaults>
        variant={active}
        onPatch={(patch) => setVariantPatch(activeVariant, patch)}
      />
      <SharedTypographySizingFields<HeadingVariantDefaults>
        variant={active}
        onPatch={(patch) => setVariantPatch(activeVariant, patch)}
      />
    </>
