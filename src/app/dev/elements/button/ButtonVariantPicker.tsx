...
export function ButtonVariantPicker({ controller }: { controller: ButtonElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code>elementButtonSchema</code> + <code>elementLayoutSchema</code>. Seeds
        start from the neutral dev foundation baseline.
      </p>
