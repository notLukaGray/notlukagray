...
export function LinkVariantPicker({ controller }: { controller: LinkElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match `elementLinkSchema` + `elementLayoutSchema`. Variant seeds start from the
