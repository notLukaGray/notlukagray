...
import { LinkAnimationControls } from "./controls/LinkAnimationControls";
import { LinkContentControls } from "./controls/LinkContentControls";
import { LinkLayoutControls } from "./controls/LinkLayoutControls";
import { LinkRuntimeControls } from "./controls/LinkRuntimeControls";
      ...
      {hasAnyCategoryVisible ? (
        <div className="grid gap-4 sm:grid-cols-2">
          {controller.visibleCategories.content ? (
            <LinkContentControls controller={controller} />
          ) : null}
          {controller.visibleCategories.layout ? (
            <LinkLayoutControls controller={controller} />
          ) : null}
          {controller.visibleCategories.traits ? (
            <LinkTraitsControls controller={controller} />
          ) : null}
          {controller.visibleCategories.animation ? (
            <LinkAnimationControls controller={controller} />
          ) : null}
          {controller.visibleCategories.runtime ? (
            <LinkRuntimeControls controller={controller} />
          ) : null}
        </div>
      ) : (
