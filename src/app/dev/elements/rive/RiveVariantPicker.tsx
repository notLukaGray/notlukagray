...
export function RiveVariantPicker({ controller }: { controller: RiveElementDevController }) {
  return (
    <section className="space-y-3 rounded-lg border border-border bg-card/20 p-4">
      ...
      <p className="text-[10px] text-muted-foreground">
        Variants match <code className="font-mono text-[10px]">elementRiveSchema</code> +{" "}
        <code className="font-mono text-[10px]">elementLayoutSchema</code>. Variant seeds start from
        the neutral dev foundation baseline.
      </p>
