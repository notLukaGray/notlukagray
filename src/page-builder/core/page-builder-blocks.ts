import { assetBaseUrl as globalAssetBaseUrl } from "@/core/lib/globals";
import { buildProxyUrl, isAssetKey } from "@/core/lib/proxy-url";
import type {
  ElementBlock,
  ResolvedPage,
  SectionBlock,
...
import {
  ...
  walkElement,
  walkSection,
} from "@/page-builder/core/resolved-assets/page-builder-asset-tree-walk";
